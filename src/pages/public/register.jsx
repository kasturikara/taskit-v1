  ...
  return (
    <div className="relative h-screen bg-sky-500">
      ...
      <div className="relative top-0 grid h-full grid-cols-1 md:grid-cols-2">
        {/* mobile atas */}
        <div
          className={`flex md:hidden flex-col items-center justify-center p-4 md:h-full h-28 md:p-8 ${fadeClass}`}
        >
        ...
        {/* kiri */}
        <div
          className={`flex flex-col items-center gap-8 p-4 bg-white md:justify-center md:p-16 text-slate-900 rounded-t-3xl md:rounded-tl-none md:rounded-e-3xl ${animationClass}`}
        >
          ...
          <div className="flex flex-col items-center justify-center w-full max-w-md gap-4">
            <p className="text-center ">
              Sudah punya akun?{" "}
              <Link to="/login" className="font-semibold text-sky-500">
                Masuk
              </Link>
            </p>
          </div>
        ...
        {/* kanan */}
        <div
          className={`hidden md:flex flex-col items-center justify-center p-4 md:h-full h-28 md:p-8 ${fadeClass}`}
        >
          <BaseballHelmet className="w-20 h-20 text-white md:w-32 md:h-32" />
          <h1 className="text-lg font-bold tracking-widest text-white md:text-xl">
            TASKIT
